...
//   SET RUN=RUN           IDENTIFIER USED FOR DATASET DATABASE TABLE
...
//SMF      DD DISP=SHR,DSN=RMFMAGIC.TSUITE.BOA.C002835.CT7X.ZRF
//SMF1     DD DISP=SHR,DSN=RMFMAGIC.TSUITE.BOA.C002835.UK7X.ZRF
